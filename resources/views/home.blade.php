                        ...
                        <a href="{{ url('/article/' . $article->id) }}" class="w-full">
                            ...
                            <div class="text-center relative z-1">
                                <div
                                    ...
                                    <h1
                                        class="text-highlight text-[6vw] md:text-[4vw] mb-2 font-bold transform hover:scale-[102%] duration-75">
                                        {{ $article->title }}</h1>
                                    <a href="/user/{{ $article->user_id }}"
                                        class="hover:underline text-light text-[3vw] md:text-[1.5vw] mb-8">{{ $article->user->name }}</a>
