...
@section('content')
    ...
    <div class="flex flex-row font-montserrat max-w-7xl w-5/6 gap-12 mx-auto my-24">
        ...
        <div class="hidden lg:flex lg:flex-col gap-12 w-2/6">
            <div>
                <h1 class="text-3xl font-bold mb-6">Discover by Categories</h1>
            ...
            <div>
                <h1 class="text-3xl font-bold mb-6">Check out these authors</h1>
